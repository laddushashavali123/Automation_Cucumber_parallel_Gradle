...
@ExtendedCucumberOptions(outputFolder = "results/", jsonReport = "results/cucumber.json", retryCount = 0
        ...
        consolidatedReport = true, consolidatedReportConfig = "src/test/resources/conf/consolidated_batch.json", usageReport = true, jsonUsageReport = "results/cukes-usage.json")
@CucumberOptions(features = "src/test/resources/features", glue = "automation.testing.test.cucumber.stepdefs", plugin = {"automation.testing.util.cucumber.CustomCucumberListener:results/ExtentReport.html", "html:results/cucumber-html-report", "json:results/cucumber.json",
        "usage:results/cukes-usage.json"}, tags = {"@cucumber-report"})
